...
class GUI:
    ...
    def __init__(self):
        self.mode_manager = MODE_MANAGER(self)
    ...
    def run(self):
        ...
        button1.clicked.connect(lambda: [self.mode_manager.handle_input(1)])
        self.layout.addWidget(button1)

        button2 = QPushButton("AI Solver")
        button2.clicked.connect(lambda: [self.mode_manager.handle_input(2)])
        self.layout.addWidget(button2)

        button3 = QPushButton("Manual")
        button3.clicked.connect(lambda: [self.mode_manager.handle_input(3)])
